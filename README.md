...
9. 查看“AI 决策过程”，确认 DeepSeek 意图、匹配日程和执行结果。
10. 点击“开启提醒”，允许浏览器通知后等待提醒时间触发。
...
7. 说出“删除开会”，系统删除匹配日程。
8. 展示 AI 决策过程，包括识别文本、意图、匹配日程和执行结果。
9. 系统对创建、查询、删除结果进行语音播报。
10. 开启提醒通知，等待日程提醒触发。
